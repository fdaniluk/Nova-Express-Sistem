...
const destinatariosRoutes = require('./destinatarios');
const guiasRoutes = require('./guias.routes');
const remitentesRoutes = require('./remitentes');
...
router.use('/clientes/:id/destinatarios', destinatariosRoutes);
router.use('/clientes/:id/remitentes', remitentesRoutes);
